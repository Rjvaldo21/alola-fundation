...
const routes = [
  ...
  { 
    path: '/program/mch/about', 
    name: 'program-mch-about', 
    component: AboutMCH, 
    meta: { title: 'About MCH' } 
  },

  {
    path: '/program/mch/facility-based',
    name: 'program-mch-facility',
    component: FacilityBased,
    meta: { title: 'Facility Based Sub Program' }
  },
